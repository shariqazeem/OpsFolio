...
const socialMediaLinks = {
  ...
  linkedin: "https://www.linkedin.com/in/shariq-shaukat786/",
  gmail: "shariqshaukat786@gmail.com",
  facebook: "https://www.facebook.com/shariq.shaukat.77",
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Automate software delivery pipelines, deployment processes, and infrastructure provisioning using tools like Jenkins, Docker, and Kubernetes."
    ),
    emoji("⚡  Implement continuous integration and deployment (CI/CD) pipelines to enable frequent and reliable software releases, ensuring faster time to market and improved collaboration between development and operations teams."),
    emoji(
      "⚡ Manage cloud infrastructure on platforms such as AWS or IBM Cloud, including provisioning, scaling, and optimization of resources."
    )
  ],
...
const techStack = {
  ...
  experience: [
    {
      Stack: "Continuous Integration and Deployment", //Insert stack or technology you have experience in
  ...
  achievementsCards: [
    {
      ...
      footerLink: [
        {
          name: "Certification",
          url: "https://drive.google.com/file/d/1tybRbOpl6xoWImk-zMQgTsUwsh1dIFjJ/view?usp=share_link"
        }
      ]
    },
    {
...
const contactInfo = {
  ...
  number: "+923114111482",
  email_address: "shariqshaukat786@gmail.com"
};
